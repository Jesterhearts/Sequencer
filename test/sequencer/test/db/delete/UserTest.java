...
public class UserTest {
    ...
    public void testDeleteUser()
    {
        ...
        if(!MongoHelper.delete(user, MongoHelper.USER_COLLECTION))
            TestHelper.failed("Delete User failed id:" + user.getId());
        
        System.out.println("Successfully deleted user:" + user.getId());
        TestHelper.passed();
    }
}